...
### デフォルトエクスポート（[[基礎 Part 11 ESM　Import＆Export|default]] [[基礎 Part 11 ESM　Import＆Export|Export]]）
...
| `import x from './x.js'` | [[基礎 Part 11 ESM　Import＆Export|default]] [[基礎 Part 11 ESM　Import＆Export|export]]を読み込み |
| `import x, { a, b } from './x.js'` | [[基礎 Part 11 ESM　Import＆Export|default]]と名前付き[[基礎 Part 11 ESM　Import＆Export|export]]を同時に読み込み |
...
## [[基礎 Part 11 ESM　Import＆Export|default]] [[基礎 Part 11 ESM　Import＆Export|export]] がある理由

| 観点 | [[基礎 Part 11 ESM　Import＆Export|default]] [[基礎 Part 11 ESM　Import＆Export|export]] | named [[基礎 Part 11 ESM　Import＆Export|export]] |
| --- | --- | --- |
| 数 | 1つだけ | 複数可 |
...
- [[基礎 Part 11 ESM　Import＆Export|default]] [[基礎 Part 11 ESM　Import＆Export|export]] はファイルの主役を明確にできる。
