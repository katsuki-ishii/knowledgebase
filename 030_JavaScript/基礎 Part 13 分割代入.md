...
aliases: [分割代入, 分割, destructuring, Destructuring]
---
# JavaScriptの[[基礎 Part 13 分割代入|分割代入]]まとめ

## 1. [[基礎 Part 13 分割代入|分割代入]]とは

配列やオブジェクトの中にある値を、短く明確な書き方で変数として取り出すための文法。通常の[[基礎 Part 8 宣言・代入・再代入|代入]]よりもコード量を減らし、目的が読み取りやすくなる。

## 2. 配列の[[基礎 Part 13 分割代入|分割代入]]
...
残りの要素をまとめて受け取るには、JavaScript文法である [[REST 概要|rest]] 構文を使う。
...
## 3. オブジェクトの[[基礎 Part 13 分割代入|分割代入]]
...
### Reactの[[基礎 Part 36 defineProps()|props]]での利用

[[基礎 Part 30 コンポーネント|コンポーネント]]が受け取るオブジェクトから必要な部分だけを抜き出す。
...
- オブジェクト[[基礎 Part 13 分割代入|分割代入]]でキー名を間違えると undefined になる。
