...
---
## 1. [[基礎 reactiveとrefの併用|reactiveとref Part 8]]の役割

Vue 3の[[基礎 リアクティブエフェクト|リアクティブ Part 19]]システムには、2つの主要な関数がある。

| 関数 | 対象 | 主な用途 | 備考 |
| --- | --- | --- | --- |
| `reactive()` | オブジェクト・配列 | 複数のプロパティを持つデータを[[基礎 リアクティブエフェクト|リアクティブ Part 19]]化 | Proxyで包む |
| `ref()` | プリミティブ値 | 数値や文字列など単一の値を[[基礎 リアクティブエフェクト|リアクティブ Part 19]]化 | `{ value: ... }` で包む |
...
## 2. [[基礎 ref関数|ref Part 4]]を[[基礎 reactive関数|reactive Part 5]]の中で使うときの挙動
...
### 例1：[[基礎 オブジェクト内のref|オブジェクト内のref Part 9]]
...
このため、Vueはプリミティブ値を `{ value: ... }` というオブジェクトで包み、そのオブジェクトを`reactive`化することで[[基礎 リアクティブエフェクト|リアクティブ Part 19]]性を実現している。

---

## 4. 混乱を避けるための指針

1. オブジェクトを[[基礎 リアクティブエフェクト|リアクティブ Part 19]]にしたいときは `reactive()` を使う。
2. 単一の値を[[基礎 リアクティブエフェクト|リアクティブ Part 19]]にしたいときは `ref()` を使う。
...
## 関連
- [[基礎 Part 9 ref関数 Part 4]]
- [[基礎 reactive関数 Part 5]]
- [[基礎 オブジェクト内のref]]
