...
- [[基礎 Part 33 グローバルCSS|グローバル]]や関数の外で変数が暴走しない（バグ防止）
...
| [[基礎 Part 8 宣言・代入・再代入|宣言]]方法 | [[基礎 Part 9ブロックとブロックスコープ|ブロックスコープ]] | 関数スコープ | [[基礎 Part 33 グローバルCSS|グローバル]]スコープ |
| --- | --- | --- | --- |
| var | × | ○ | ○ |
| let | ○ | ○ | ○ |
| const | ○ | ○ | ○ |
...
→ そのスコープ（たとえば関数や[[基礎 Part 33 グローバルCSS|グローバル]]）で有効。
