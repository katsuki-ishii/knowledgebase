...
- ブラウザはCookieを**ローカルのデータベース（SQLite形式）**に保存。
...
- `Cookie:` ヘッダーに条件一致したCookieを`;`区切りで送信。
- JavaScript不要（HTTPプロトコルの標準機能）。

**用語**：

- **HTTPヘッダー**：ブラウザとサーバーがやり取りする追加情報の部分。Cookieはこの中で送られる。
