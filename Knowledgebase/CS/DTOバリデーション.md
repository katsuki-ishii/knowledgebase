...
**DTOバリデーションとは、外部から入ってくるデータが「期待した形・型・制約」を満たしているかを、業務処理に入る前にチェックする仕組みである。**

- DTO = Data Transfer Object（データ受け渡し専用の入れ物）
- バリデーション = 正しさの検証
