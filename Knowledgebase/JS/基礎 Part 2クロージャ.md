...
- でもクロージャだと、**親関数の変数を“子関数がずっと持っていられる”**
...
- でも、返された関数（クロージャ）はその number をずっと覚えている
...
- グローバル変数を汚さずに「状態を持つ関数」を作れる
- カプセル化（安全な情報の隠蔽）ができる

### Q. 子関数＝クロージャ？

- 親の変数を参照していればクロージャ、そうでなければ普通の関数
